...
# ---------------------------------------------------------------------------------------------------------------------------------  
    ...
    def update_treeview():
        ...
        lol = mysql.connector.connect(host='sql.freedb.tech',user='freedb_painum',password='x6dqkycs2!nDGgR',database='freedb_bank_system')
        cur = lol.cursor()
...
# ====================================================================================================================================
    ...
    def create_user():
        ...
        try:
            connection = mysql.connector.connect(host='sql.freedb.tech',user='freedb_painum',password='x6dqkycs2!nDGgR',database='freedb_bank_system')
...
# ================================================================================================================================================
    ...
    def del_acc():
        ...
        if not uid:
            ...
            return
        try:
            conn = mysql.connector.connect(host='sql.freedb.tech',user='freedb_painum',password='x6dqkycs2!nDGgR',database='freedb_bank_system')
            cursor = conn.cursor()
